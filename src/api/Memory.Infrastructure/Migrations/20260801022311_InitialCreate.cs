    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:media_kind", "image,video")
                .Annotation("Npgsql:Enum:media_status", "pending,ready,failed")
                .Annotation("Npgsql:Enum:membership", "free,premium");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_media_assets_posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_posts_UserId_OccurredOn_CreatedAt",
                table: "posts",
